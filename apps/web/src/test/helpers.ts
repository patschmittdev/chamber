...
export function mockElectronAPI(): ElectronAPI {
  ...
  return {
    chat: {
      ...
      getConversationVariants: vi.fn().mockResolvedValue([]),
      switchActiveVariant: vi.fn().mockResolvedValue({ sessionId: '', messages: [], conversations: [] }),
      forkConversation: vi.fn().mockResolvedValue({ sessionId: '', messages: [], conversations: [] }),
    },
    conversationHistory: {
    ...
    mind: {
      ...
      setGlobalCustomInstructionsEnabled: vi.fn().mockImplementation((mindId: string, enabled: boolean) => Promise.resolve({
        mindId,
        mindName: 'Test',
      ...
      getInstructionPrecedence: vi.fn().mockImplementation((mindId: string) => Promise.resolve({
        mindId,
        mindName: 'Test',
    ...
    lens: {
      ...
      registerCanvasGrant: vi.fn().mockResolvedValue(undefined),
    },
    auth: {
