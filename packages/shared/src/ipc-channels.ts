...
export const IPC = {
  CHAT: {
    ...
    GET_CONVERSATION_VARIANTS: 'chat:getConversationVariants',
    SWITCH_ACTIVE_VARIANT: 'chat:switchActiveVariant',
  ...
  VOICE: {
    GET_CONFIG: 'voice:getConfig',
    SAVE_CONFIG: 'voice:saveConfig',
    CHANGED: 'voice:changed',
    GET_PERMISSION_STATE: 'voice:getPermissionState',
    OPEN_MIC_PREFERENCES: 'voice:openMicPreferences',
    GET_MODEL_STATUS: 'voice:getModelStatus',
    DOWNLOAD_MODEL: 'voice:downloadModel',
    CANCEL_DOWNLOAD: 'voice:cancelDownload',
    MODEL_PROGRESS: 'voice:modelProgress',
    START_SESSION: 'voice:startSession',
    APPEND_AUDIO: 'voice:appendAudio',
    END_SESSION: 'voice:endSession',
    TRANSCRIPT: 'voice:transcript',
    TEST_MIC: 'voice:testMic',
  },
  CHATROOM: {
    SEND: 'chatroom:send',
